...
function showData() {
  ...
  for (let i = 0; i < dataPro.length; i++) {
    table += `<tr>
           ...
           <td ><button id="update" onclick="updateData(${i})" class="btn btn-primary  " >update</button></td>
           <td ><button id="delete" onclick="deleteData(${i})"  class="btn btn-danger ">delete</button></td>
         </tr>`;
  }
